...
> 📘 **النسخة الأحدث والأفصح من هذا الدليل**: `RENDER_DEPLOY_GUIDE.md` في جذر المشروع — خطوة بخطوة مع جداول متغيرات البيئة الكاملة وقائمة فحص بعد النشر وجدول حل المشاكل. هذا الملف مرجع تقني مختصر.
